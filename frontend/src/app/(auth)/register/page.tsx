            ...
            <div className="w-full max-w-sm mx-auto">
              <div className="w-full space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-text-muted font-medium">Join us and start building your perfect setup</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-1">
                    <label htmlFor="fullName" className="text-xs font-bold text-text-dim uppercase tracking-widest ml-1">Full Name</label>
                    <input
                      ...
                      className="block w-full rounded-xl bg-surface border border-border px-4 py-3 text-foreground placeholder:text-text-dim focus:border-brand-red focus:bg-background focus:outline-none focus:ring-4 focus:ring-brand-red/5 transition-all"
                    />
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs font-bold uppercase tracking-widest"><span className="bg-background px-4 text-text-dim">OR</span></div>
                </div>
                <p className="text-center text-sm text-text-muted font-medium">Already have an account? <a href="/login" className="font-bold text-foreground hover:text-brand-red transition-colors underline decoration-2 underline-offset-4">Sign In</a></p>
              </div>
            </div>
          </div>
        </div>
