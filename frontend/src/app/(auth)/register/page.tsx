              ...
              <div className="w-full space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-400">
                    Join us and start building your perfect setup
                  </p>
                </div>
                  ...
                  {formData.password && (
                    <div className="space-y-1 text-sm">
                      ...
                      {formData.confirmPassword && (
                        <p className={passwordsMatch ? "text-green-400" : "text-red-400"}>
                ...
                <p className="text-center text-sm text-gray-400">
                  ...
                  <a href="/login" className="font-semibold text-white hover:text-gray-300">
                    Sign In
                  </a>
                </p>
              </div>
