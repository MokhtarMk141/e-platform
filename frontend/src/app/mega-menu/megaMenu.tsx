  ...
  Products: [
    {
      ...
      items: [
        { label: "CPUs & Processors", key: "cpu", href: "/product-page?category=cpus-and-processors&categoryKey=cpu" },
        { label: "Motherboards", key: "motherboard", href: "/product-page?category=motherboards&categoryKey=motherboard" },
        { label: "Memory (RAM)", key: "ram", href: "/product-page?category=memory-ram&categoryKey=ram" },
        { label: "Graphics Cards", key: "gpu", href: "/product-page?category=graphics-cards&categoryKey=gpu" },
        { label: "Storage", key: "storage", href: "/product-page?category=storage&categoryKey=storage" },
        { label: "Power Supplies", key: "psu", href: "/product-page?category=power-supplies&categoryKey=psu" },
      ],
    },
    {
      title: "Peripherals & Cooling",
      items: [
        { label: "CPU Cooling", key: "cooling", href: "/product-page?category=cpu-cooling&categoryKey=cooling" },
        { label: "PC Cases", key: "case", href: "/product-page?category=pc-cases&categoryKey=case" },
        { label: "Monitors", key: "monitor", href: "/product-page?category=monitors&categoryKey=monitor" },
        { label: "Keyboards", key: "keyboard", href: "/product-page?category=keyboards&categoryKey=keyboard" },
        { label: "Mice", key: "mouse", href: "/product-page?category=mice&categoryKey=mouse" },
        { label: "Headsets", key: "headset", href: "/product-page?category=headsets&categoryKey=headset" },
      ],
    },
  ],
};
